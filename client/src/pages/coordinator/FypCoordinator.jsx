...
export const FinalDefenseCoordinator = () => {
  ...
  const fetchFinalDefenseProjects = async () => {
    try {
      ...
      const response = await fetch('https://fyp-process-automation.vercel.app/api/projects/evaluation-list/final');
  ...
  const handleSchedule = async () => {
    ...
    try {
      setProcessing(true);
      const res = await fetch(`https://fyp-process-automation.vercel.app/api/projects/schedule-final-defense/${selectedProject._id}`, {
        method: 'PUT',
            ...
            {projects.filter(p => p.finalDefense?.scheduledDate).map(p => (
              <div key={p._id} className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                ...
                {p.finalDefense?.finalPptUrl ? (
                   <a href={`https://fyp-process-automation.vercel.app/${p.finalDefense.finalPptUrl}`} target="_blank" rel="noopener noreferrer" className="text-blue-400 text-xs underline">Download Final PPT</a>
...
export const InitialDefenseEvaluation = () => {
  ...
  const fetchInitialDefenseProjects = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://fyp-process-automation.vercel.app/api/projects/initial-defense-projects');
      const data = await response.json();
  ...
  const handleSubmitMarks = async () => {
    ...
    try {
      setProcessing(true);
      const response = await fetch(`https://fyp-process-automation.vercel.app/api/projects/submit-initial-defense-marks/${selectedProject._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          role: 'coordinator', 
                ...
                {projects.map((project) => {
                  ...
                  return (
                    <tr key={project._id} className="hover:bg-gray-700/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <a
                          href={`https://fyp-process-automation.vercel.app/${project.presentationUrl}`}
                          target="_blank"
              ...
              <div className="bg-gray-900 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <a
                      href={`https://fyp-process-automation.vercel.app/${selectedProject.presentationUrl}`}
                      target="_blank"
                      rel="noopener noreferrer"
...
export const SrsSdsCoordinator = () => { // ← ADD 'export' HERE
  ...
  const fetchSrsSdsProjects = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://fyp-process-automation.vercel.app/api/projects/srs-sds-evaluation-projects');
      const data = await response.json();
  ...
  const handleSubmitMarks = async () => {
    ...
    try {
      setProcessing(true);
      const response = await fetch(`https://fyp-process-automation.vercel.app/api/projects/submit-srs-sds-marks/${selectedProject._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          role: 'coordinator', 
                ...
                {projects.map((project) => {
                  ...
                  return (
                    <tr key={project._id} className="hover:bg-gray-700/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <a
                          href={`https://fyp-process-automation.vercel.app/${project.srsUrl}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg transition-colors inline-flex items-center"
                        >
                      ...
                      <td className="px-6 py-4">
                        <a
                          href={`https://fyp-process-automation.vercel.app/${project.sdsUrl}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg transition-colors inline-flex items-center"
                        >
              ...
              <div className="bg-gray-900 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <a
                      href={`https://fyp-process-automation.vercel.app/${selectedProject.srsUrl}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-400 hover:underline block"
                    >
                  ...
                  <div>
                    ...
                    <a
                      href={`https://fyp-process-automation.vercel.app/${selectedProject.sdsUrl}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-400 hover:underline block"
                    >
...
export const Dashboard = () => {
  ...
  const fetchSupervisors = async () => {
    try {
      const response = await fetch('https://fyp-process-automation.vercel.app/api/projects/supervisors');
      const data = await response.json();
  ...
  const fetchPendingProposals = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://fyp-process-automation.vercel.app/api/projects/pending');
      const data = await response.json();
  ...
  const handleDecision = async (projectId, status) => {
    ...
    try {
      ...
      let response;
      if (status === 'Approved') {
        response = await fetch(`https://fyp-process-automation.vercel.app/api/projects/assign-supervisor/${projectId}`, {
          method: 'PUT',
          headers: {
        ...
        response = await fetch(`https://fyp-process-automation.vercel.app/api/projects/decision/${projectId}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-gray-700">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <a
                  href={`https://fyp-process-automation.vercel.app/${selectedProposal.documentUrl}`}
                  target="_blank"
                  rel="noopener noreferrer"
...
export const AllProjects = () => {
  ...
  const fetchAllProjects = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://fyp-process-automation.vercel.app/api/projects/defense-pending');
      const data = await response.json();
       
      // Also fetch pending proposals
      const pendingResponse = await fetch('https://fyp-process-automation.vercel.app/api/projects/pending');
              ...
              <tbody className="divide-y divide-gray-700/50">
                {filteredProjects.map((project) => (
                  <tr key={project._id} className="hover:bg-gray-700/30 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <a
                        href={`https://fyp-process-automation.vercel.app/${project.documentUrl}`}
                        target="_blank"
                        rel="noopener noreferrer"
...
export const ScheduleDefense = () => {
  ...
  const handleScheduleDefense = async () => {
    ...
    try {
      setProcessing(true);
      const response = await fetch(`https://fyp-process-automation.vercel.app/api/projects/assign-defense/${selectedProject._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
